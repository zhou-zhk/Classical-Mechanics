...
\end{equation} So we get \begin{equation}
    \mathbf{\dot{q}} = \frac{\partial H}{\partial \mathbf{p}}, \;\; \frac{\partial H}{\partial \mathbf{q}} = - \frac{\partial L}{\partial \mathbf{q}}=\mathbf{\dot{p}} \;\; \frac{\partial H}{\partial t}=-\frac{\partial L}{\partial t}. 
\end{equation}
