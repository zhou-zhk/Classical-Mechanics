...
\textbf{Corollary} $\frac{\mathrm{d}H}{\mathrm{d}t} = \frac{\partial H}{\partial t}$: If a system whose $hamiltonian$ function satisfies $\frac{\partial H}{\partial t}=0$, which means do not depend explictly on time, ...
