...
\end{align}
where $H(\mathrm{p}, \mathrm{q}, t) = \mathrm{p}\dot{\mathrm{q} - L (\mathrm{q}, \dot{\mathrm{q}}, t)}$ is the Legendre transform of the lagrangian function, which is viewed as a function of $\dot{\mathrm{q}}$. 
