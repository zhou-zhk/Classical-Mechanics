...
For central fields, a problem can be reduced to a one-dimensional problem by using polar coordinates. The symmetry to a problem is crucial. 
...
\end{equation} in which $N$ is the parameter tending to infinity, and the initial conditions on $\gamma$: ...  . 
The evolution of the coordinate $q_1$ under a motion with these initial conditions ... 
